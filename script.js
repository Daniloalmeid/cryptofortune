...
function getCoinValues() {
    ...
    function getCoinValues() {
        const coins = ["bitcoin", "ethereum", "litecoin", "binance coin", "xrp", "cardano", "solana", "dogecoin", "polygon", "tron", "polkadot", "axie-infinity"];
        const url = `https://api.coingecko.com/api/v3/simple/price?ids=${coins.join(",")}&vs_currencies=usd`;
        ...
        .then(data => {
          ...
          document.getElementById("avax-value").textContent = data.axie-infinity.usd;
        })
        .catch(error => {
